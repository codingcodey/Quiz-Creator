    ...
    >
          ...
          >
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button
                ...
                className="px-4 py-2.5 bg-error/20 text-error border border-error/30 rounded-xl hover:bg-error/30 transition-colors duration-300"
              >
      ...
      <header className="sticky top-0 z-[100] bg-bg-primary/80 backdrop-blur-md border-b border-border">
        ...
        <div className="hidden md:flex max-w-4xl mx-auto px-6 py-4 items-center justify-between">
          <button
            onClick={handleBackClick}
            className="flex items-center gap-2 px-3 py-2.5 text-text-secondary hover:text-text-primary transition-colors duration-300 group rounded-lg hover:bg-bg-secondary min-h-[44px]"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
            </svg>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-4" data-add-question>
            <button
              ...
              className="group flex items-center justify-center gap-2 py-4 bg-bg-secondary border border-border rounded-xl text-text-primary hover:border-accent/50 hover:text-accent transition-colors duration-300"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="group flex items-center justify-center gap-2 py-4 bg-bg-secondary border border-border rounded-xl text-text-primary hover:border-purple-400/50 hover:text-purple-400 transition-colors duration-300"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="group flex items-center justify-center gap-2 py-4 bg-bg-secondary border border-border rounded-xl text-text-primary hover:border-blue-400/50 hover:text-blue-400 transition-colors duration-300"
            >
