      ...
      <div className="min-h-screen bg-bg-primary">
        ...
        <div className="fixed top-4 right-4 z-50 flex items-center gap-3 opacity-0 animate-slide-in-right stagger-1">
          ...
          <button
            type="button"
            onClick={signOut}
            className="group flex items-center gap-2 px-3 py-2 bg-bg-secondary text-text-secondary border border-border rounded-lg appearance-none transition-all duration-300 h-10 hover:bg-error hover:border-error hover:text-bg-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-error/40"
            title="Sign out"
          >
